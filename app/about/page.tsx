...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white pt-[84px] lg:pt-[96px]">
      ...
      {/* ── AGENT PHOTO — below Toyota Differences ── */}
      <section className="bg-[#0A0A0A] py-24 lg:py-28" id="contact">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <span className="section-label !text-brand-red">Get In Touch</span>
              <h2 className="section-title !text-white mb-6">Let's Find Your<br />Perfect Car</h2>
